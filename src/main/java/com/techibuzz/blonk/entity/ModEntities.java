...
public class ModEntities {
    ...
    public static final EntityType<ShellEntity> SHELL = Registry.register(
            ...
            EntityType.Builder.<ShellEntity>of(ShellEntity::new, MobCategory.MISC).sized(4/16F, 4/16F).build(SHELL_KEY)
    );
    ...
    public static final EntityType<ShellEntity> DRAGON_SHELL = Registry.register(
            BuiltInRegistries.ENTITY_TYPE, DRAGON_SHELL_KEY,
            EntityType.Builder.<ShellEntity>of(ShellEntity::new, MobCategory.MISC).sized(4/16F, 4/16F).build(DRAGON_SHELL_KEY)
    );
    ...
    public static final EntityType<ShellEntity> HEAT_HELL = Registry.register(
            BuiltInRegistries.ENTITY_TYPE, HEAT_SHELL_KEY,
            EntityType.Builder.<ShellEntity>of(ShellEntity::new, MobCategory.MISC).sized(4/16F, 4/16F).build(HEAT_SHELL_KEY)
    );
    ...
    public static final EntityType<ShellEntity> HE_SHELL = Registry.register(
            BuiltInRegistries.ENTITY_TYPE, HE_SHELL_KEY,
            EntityType.Builder.<ShellEntity>of(ShellEntity::new, MobCategory.MISC).sized(4/16F, 4/16F).build(HE_SHELL_KEY)
    );
    ...
    public static final EntityType<ShellEntity> NUCLEAR_SHELL = Registry.register(
            BuiltInRegistries.ENTITY_TYPE, NUCLEAR_SHELL_KEY,
            EntityType.Builder.<ShellEntity>of(ShellEntity::new, MobCategory.MISC).sized(4/16F, 4/16F).build(NUCLEAR_SHELL_KEY)
    );
    ...
    public static final EntityType<ShellEntity> SMOKE_SHELL = Registry.register(
            BuiltInRegistries.ENTITY_TYPE, SMOKE_SHELL_KEY,
            EntityType.Builder.<ShellEntity>of(ShellEntity::new, MobCategory.MISC).sized(4/16F, 4/16F).build(SMOKE_SHELL_KEY)
    );
